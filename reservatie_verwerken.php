        ...
        if ($reservations !== null) {
            foreach ($reservations as $reservation) {
                ...
                <fieldset>
                    ...
                    <input type="text" name="adults" id="adults" value="<?php echo $reservation['adults']; ?>" /><br>

                    <label>children:</label><br>
                    <input type="text" name="children" id="children" value="<?php echo $reservation['children']; ?>" /><br>

                    <label>days:</label><br>
                    <input type="text" name="days" id="days" value="<?php echo $reservation['days']; ?>" /><br>
